...
const features = [
  { icon: Bus, title: 'Mock Tracking', description: 'Monitor route progress without live GPS' },
  { icon: Clock, title: 'Smart Scheduling', description: 'Manage pickup and drop timings by shift' },
  { icon: Users, title: 'Seat Management', description: 'Reserve seats and manage availability' },
  { icon: MapPin, title: 'Route Planning', description: 'Review stop order and campus routes' },
];
...
const Index = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const success = await login(email, password, selectedRole, collegeId);
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
              Seamless bus booking, mock route visibility, and smart seat management for your campus commute
            </p>
          </motion.div>
          ...
          <Card className="max-w-lg mx-auto shadow-xl">
            ...
            <CardContent>
              ...
              <p className="text-center text-sm text-muted-foreground mt-6">
                Demo mode: enter any credentials to explore. Live maps, real-time tracking, and service-backed notifications are intentionally mocked in this build.
              </p>
            </CardContent>
          </Card>
        </motion.div>
